...
**Staff Cloud Engineer** with experience spanning the full SDLC — 
...
current_mission:
  company: Dexcom
  focus: Healthcare cloud infrastructure (customer-first, multi-region, zero-downtime)
  philosophy: "Automate everything. Document the rest."
```
---
